"""
A utility to program the ROM standing in for a tape/card reader for the relay computer.

Run with `python risc_like_8bit_relay_input.py`. Will output a file to the `target_file`.
